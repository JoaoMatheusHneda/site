...
Esse post teve como objetivo iniciar a série de posts sobre gráficos interativos em R e apresentar alguns comandos das bibliotecas gráfica plotly e dygraphs do R. Esse post não teve como objetivo esgotar as possibilidades de criação de gráficos interativos no R, mas mostrar algumas funcionalidades de como isso pode ser feito. Portanto, se tiver interesse em aprender mais, há várias outras fontes sobre o assunto. Além disso, sinta-se a vontade em entrar em contato com o autor desse post se assim desejar.
