...
Esse texto foi escrito como parte de uma série de posts para mostrar algumas bibliotecas do R que auxiliam na construção de gráficos interativos. Caso não tenha lido a [parte 1](www.teste.com) sobre essa série de posts, consulte o link blabla. Se já fez a leitura da parte 1, o texto da parte 2 foi feita para mostrar mais detalhes sobre gŕaficos interativos com o pacote **highcharter**.
...
Esse post teve como objetivo iniciar a série de posts sobre gráficos interativos em R e apresentar alguns comandos da biblioteca gráfica highcharter do R. Esse post não teve como objetivo esgotar as possibilidades de criação de gráficos interativos no R, mas mostrar algumas funcionalidades sobre o tema.

Muito obrigado por ter lido. Espero que tenha gostado. Continue aprendendo!
